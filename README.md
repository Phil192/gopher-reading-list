...
- [Five things that make Go fast](https://dave.cheney.net/2014/06/07/five-things-that-make-go-fast) V
- [Logging, interfaces, and allocation · Don't Panic](http://commaok.xyz/post/interface-allocs/) V
...
- [There is no pass-by-reference in Go | Dave Cheney](https://dave.cheney.net/2017/04/29/there-is-no-pass-by-reference-in-go) V
...
- [Function Types in Go (golang)](http://jordanorelli.com/post/42369331748/function-types-in-go-golang) V
...
- [Examples For Using io.Pipe in Go - zupzup](https://zupzup.org/io-pipe-go/) V
